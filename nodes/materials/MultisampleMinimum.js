...
var fragmentShader = [
	...
	"	gl_FragColor = min(gl_FragColor, textureCube( cubeMap, vec3( flipX * vWorldPosition2.x, vWorldPosition2.yz ) ) );",
	"	gl_FragColor = min(gl_FragColor, textureCube( cubeMap, vec3( flipX * vWorldPosition3.x, vWorldPosition3.yz ) ) );",
	"	gl_FragColor = min(gl_FragColor, textureCube( cubeMap, vec3( flipX * vWorldPosition4.x, vWorldPosition4.yz ) ) );",
	"	gl_FragColor = min(gl_FragColor, textureCube( cubeMap, vec3( flipX * vWorldPosition5.x, vWorldPosition5.yz ) ) );",
	"	gl_FragColor = min(gl_FragColor, textureCube( cubeMap, vec3( flipX * vWorldPosition6.x, vWorldPosition6.yz ) ) );",
