...
function CubeMapMultiSampleRotateMaterial(params) {
	params = params || {};
	defaults(params, {
...
CubeMapMultiSampleRotateMaterial.prototype = Object.create(BaseOneMaterial.prototype);

module.exports = CubeMapMultiSampleRotateMaterial;