...
var fragmentShader = [
	...
	"	gl_FragColor = min(gl_FragColor, textureCube( cubeMap, vec3( flipX * worldPosition2.x, worldPosition2.yz ) ) );",
	"	gl_FragColor = min(gl_FragColor, textureCube( cubeMap, vec3( flipX * worldPosition3.x, worldPosition3.yz ) ) );",
	"	gl_FragColor = min(gl_FragColor, textureCube( cubeMap, vec3( flipX * worldPosition4.x, worldPosition4.yz ) ) );",
	"	gl_FragColor = min(gl_FragColor, textureCube( cubeMap, vec3( flipX * worldPosition5.x, worldPosition5.yz ) ) );",
	"	gl_FragColor = min(gl_FragColor, textureCube( cubeMap, vec3( flipX * worldPosition6.x, worldPosition6.yz ) ) );",
